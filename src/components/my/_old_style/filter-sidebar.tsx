  ...
  const FilterContent = () => (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Button variant="ghost" size="sm" onClick={clearAll} className='text-primary bg-secondary-foreground hover:text-primary hover:bg-primary-foreground'>
          Clear All
        </Button>
      </div>
      ...
      <div className="mb-4">
        ...
        <select id="groupBy" className="w-full mt-1 rounded-md border-gray-300 bg-primary text-primary-foreground p-1">
      ...
      <div className="lg:hidden absolute left-4">
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="outline" className="mb-4 border-primary text-primary bg-secondary-foreground hovrer:border-secondary hover:text-secondary hover:bg-primary-foreground">
              <Filter className="mr-2 h-4 w-4" />
              Filters
            </Button>
          </SheetTrigger>
